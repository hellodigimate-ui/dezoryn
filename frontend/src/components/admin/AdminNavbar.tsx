    ...
    <header className="sticky top-0 z-30 h-16 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 px-4 lg:px-6 flex items-center justify-between font-['Plus_Jakarta_Sans',sans-serif] transition-colors duration-300">
      ...
      <div className="hidden md:flex items-center flex-1 max-w-md mx-6">
        <div className="relative w-full group">
          <Search className="w-4 h-4 absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 group-focus-within:text-cyan-500 dark:group-focus-within:text-cyan-400 transition-colors" />
          <input
            type="text"
            placeholder="Search pages, users, media, settings..."
            className="w-full pl-10 pr-12 py-2 rounded-2xl bg-slate-100/90 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/60 text-xs font-semibold text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-500/80 focus:bg-white dark:focus:bg-slate-900 transition-all shadow-xs"
          />
          <kbd className="absolute right-3 top-1/2 -translate-y-1/2 px-2 py-0.5 rounded-lg bg-slate-200/80 dark:bg-slate-800 text-[10px] font-mono font-bold text-slate-500 dark:text-slate-400 border border-slate-300/60 dark:border-slate-700/80 pointer-events-none shadow-2xs">
            ⌘K
          </kbd>
        </div>
      </div>
